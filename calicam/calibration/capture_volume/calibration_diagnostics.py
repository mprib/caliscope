...
# def get_xyz_points(array_points_error_data: ArrayPointsErrorData):
#     """Get 3d positions arrived at by bundle adjustment"""
#     n_cameras = len(array_points_error_data.camera_array.cameras)
#     xyz = array_points_error_data.model_params[n_cameras * CAMERA_PARAM_COUNT :]
#     xyz = xyz.reshape(-1, 3)
...
#     return diagnostic_data.point_estimate_data.obj_corner_id
