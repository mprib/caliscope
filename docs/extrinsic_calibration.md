...
2. Ensure that videos were synchronized when recording, or provide a [`frame_timestamps.csv`](project_setup.md#frame_timestampscsv) file so that caliscope can perform the synchronization during processing.
