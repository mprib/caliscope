...
def generate_keypoints(project_dir: Path, tracker: Tracker):
    ...
    raw_video_dir = fixture_project_dir / "calibration/extrinsic"
    ...
    target_output_file = fixture_project_dir / f"calibration/extrinsic/{aruco_tracker.name}/xy_{aruco_tracker.name}.csv"
...
if __name__ == "__main__":
    ...
    generate_keypoints(fixture_project_dir, aruco_tracker)
