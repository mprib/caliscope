...
class ReprojectionReport:
    ...
    by_point: dict[tuple[int, int], float]  # (object_id, keypoint_id) -> rmse
    ...
    raw_errors: pd.DataFrame  # columns: sync_index, cam_id, object_id, keypoint_id, error_x, error_y, euclidean_error
