...
class WorkspaceSummaryWidget(QWidget):
    ...
    def place_widgets(self):
        ...
        layout.addWidget(self.status_HTML, 0, 0, 1, 4)
        ...
        layout.addLayout(camera_spin_layout, 1, 0)
        layout.addWidget(self.reload_workspace_btn, 1, 1)
        layout.addWidget(self.open_workspace_folder_btn, 1, 2)
        layout.addWidget(self.calibrate_btn, 1, 3)
