...
if __name__ == "__main__":
    ...
    # Handle Wayland display issues on Linux
    ...
    if not xyz_path.exists() or not camera_array_path.exists():
        print(f"Test data missing at {session_path}")
        sys.exit(1)
    ...
    if wireframe_path.exists():
        ...
        segments = wireframe_config.segments
    ...
    widget.setWindowTitle("Playback Triangulation (PyVista)")
    widget.show()
