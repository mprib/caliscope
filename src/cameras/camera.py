...
# see above for constants used to access properties
    def __init__(self, port):
        ...
        if success:
            ...
            self.capture.set(cv2.CAP_PROP_BUFFERSIZE, 1)  # from https://stackoverflow.com/questions/58293187/opencv-real-time-streaming-video-capture-is-slow-how-to-drop-frames-or-getanother thread signaled a change to mediapipe overley-sync
